...
const CanvasToolbar = ({ page }) => {
  ...
  const { pageContent, isDirty, settingsPanelVisible, selectedWidget, savePage, resetChanges, toggleSettingsPanel } = usePageBuilderStore();
      ...
      <div className="px-6 py-3 flex items-center justify-between border-b border-gray-100">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            ...
            title={isSaving ? 'Saving...' : 'Save Page'}
          >
            {isSaving ? (
