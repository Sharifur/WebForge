...
class ListWidget extends BaseWidget
{
    ...
    public function getGeneralFields(): array
    {
        ...
        $control->addGroup('list_type', 'List Configuration')
            ->registerField('list_style', FieldManager::SELECT()
                ->setLabel('List Type')
            ...
            ->registerField('ordered_type', FieldManager::SELECT()
            ...
            ->registerField('unordered_type', FieldManager::SELECT()
            ...
            ->registerField('custom_icon', FieldManager::ICON()
        ...
        $control->addGroup('items', 'List Items')
            ->registerField('list_items', FieldManager::REPEATER()
                ->setLabel('List Items')
                ->setDefault([
        ...
        $control->addGroup('behavior', 'List Behavior')
            ->registerField('enable_nested', FieldManager::TOGGLE()
                ->setLabel('Enable Nested Lists')
                ->setDefault(true)
                ->setDescription('Allow nested sub-lists within items')
            )
            ->registerField('start_number', FieldManager::NUMBER()
            ...
            ->registerField('reverse_order', FieldManager::TOGGLE()
    ...
    public function getStyleFields(): array
    {
        ...
        $control->addGroup('container', 'List Container')
            ->registerField('list_alignment', FieldManager::SELECT()
            ...
            ->registerField('list_position', FieldManager::SELECT()
        ...
        $control->addGroup('colors', 'Colors')
            ...
            ->registerField('marker_color', FieldManager::COLOR()
            ...
            ->registerField('link_color', FieldManager::COLOR()
                ->setLabel('Link Color')
                ->setDefault('#007cba')
                ->setSelectors([
            ...
            ->registerField('link_hover_color', FieldManager::COLOR()
        ...
        $control->addGroup('spacing', 'Spacing')
            ->registerField('item_spacing', FieldManager::NUMBER()
            ...
            ->registerField('nested_indent', FieldManager::NUMBER()
            ...
            ->registerField('marker_spacing', FieldManager::NUMBER()
            ...
            ->registerField('list_padding', FieldManager::DIMENSION()
            ...
            ->registerField('list_margin', FieldManager::DIMENSION()
        ...
        $control->addGroup('icon_style', 'Custom Icon Style')
            ...
            ->registerField('icon_background', FieldManager::COLOR()
            ...
            ->registerField('icon_padding', FieldManager::DIMENSION()
