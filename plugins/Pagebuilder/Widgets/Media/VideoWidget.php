...
class VideoWidget extends BaseWidget
{
    ...
    public function getGeneralFields(): array
    {
        ...
        $control->addGroup('source', 'Video Source')
            ->registerField('video_type', FieldManager::SELECT()
                ->setLabel('Video Type')
                ->setDefault('youtube')
                ->setOptions([
                    'youtube' => 'YouTube',
            ...
            ->registerField('youtube_url', FieldManager::URL()
            ...
            ->registerField('vimeo_url', FieldManager::URL()
                ->setLabel('Vimeo URL')
                ->setDefault('')
            ...
            ->registerField('hosted_url', FieldManager::IMAGE()
                ->setLabel('Video File')
                ->setDefault('')
            ...
            ->registerField('embed_code', FieldManager::TEXTAREA()
                ->setLabel('Embed Code')
                ->setDefault('')
                ->setRows(5)
        ...
        $control->addGroup('settings', 'Video Settings')
            ...
            ->registerField('custom_aspect_ratio', FieldManager::TEXT()
            ...
            ->registerField('start_time', FieldManager::NUMBER()
            ...
            ->registerField('end_time', FieldManager::NUMBER()
        ...
        $control->addGroup('playback', 'Playback Options')
            ...
            ->registerField('muted', FieldManager::TOGGLE()
                ->setLabel('Muted')
                ->setDefault(false)
                ->setDescription('Start with audio muted')
            )
            ->registerField('loop', FieldManager::TOGGLE()
                ->setLabel('Loop')
                ->setDefault(false)
                ->setDescription('Replay video when it ends')
            )
            ->registerField('controls', FieldManager::TOGGLE()
                ->setLabel('Show Controls')
                ->setDefault(true)
                ->setDescription('Display video player controls')
            )
            ->registerField('privacy_mode', FieldManager::TOGGLE()
        ...
        $control->addGroup('overlay', 'Poster & Overlay')
            ->registerField('show_poster', FieldManager::TOGGLE()
                ->setLabel('Show Poster Image')
                ->setDefault(false)
                ->setDescription('Display custom poster image before playing')
            )
            ->registerField('poster_image', FieldManager::IMAGE()
            ...
            ->registerField('show_play_button', FieldManager::TOGGLE()
                ->setLabel('Show Play Button Overlay')
                ->setDefault(true)
                ->setCondition(['show_poster' => true])
                ->setDescription('Display play button over poster image')
            )
            ->registerField('lazy_load', FieldManager::TOGGLE()
                ->setLabel('Lazy Load')
                ->setDefault(true)
    ...
    public function getStyleFields(): array
    {
        ...
        $control->addGroup('play_button', 'Play Button Style')
            ->registerField('play_button_size', FieldManager::NUMBER()
            ...
            ->registerField('play_button_color', FieldManager::COLOR()
            ...
            ->registerField('play_button_background', FieldManager::COLOR()
            ...
            ->registerField('play_button_hover_color', FieldManager::COLOR()
            ...
            ->registerField('play_button_hover_background', FieldManager::COLOR()
            ...
            ->registerField('play_button_border_radius', FieldManager::NUMBER()
        ...
        $control->addGroup('poster_style', 'Poster Style')
            ->registerField('poster_object_fit', FieldManager::SELECT()
            ...
            ->registerField('poster_overlay', FieldManager::COLOR()
                ->setLabel('Poster Overlay')
                ->setDefault('')
                ->setCondition(['show_poster' => true])
                ->setDescription('Color overlay on poster image')
            )
            ->registerField('poster_overlay_opacity', FieldManager::NUMBER()
