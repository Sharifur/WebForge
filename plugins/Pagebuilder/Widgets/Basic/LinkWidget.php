...
class LinkWidget extends BaseWidget
{
    ...
    public function getGeneralFields(): array
    {
        ...
        $control->addGroup('content', 'Link Content')
            ->registerField('link_text', FieldManager::TEXT()
                ->setLabel('Link Text')
            ...
            ->registerField('link_title', FieldManager::TEXT()
                ->setLabel('Link Title')
                ->setDefault('')
        ...
        $control->addGroup('type', 'Link Type & Style')
            ->registerField('link_style', FieldManager::SELECT()
                ->setLabel('Link Style')
                ->setDefault('text')
                ->setOptions([
                    'text' => 'Text Link',
        ...
        $control->addGroup('icon', 'Icon Settings')
            ...
            ->registerField('icon_only', FieldManager::TOGGLE()
                ->setLabel('Icon Only')
                ->setDefault(false)
                ->setCondition(['show_icon' => true])
        ...
        $control->addGroup('behavior', 'Link Behavior')
            ...
            ->registerField('link_rel', FieldManager::SELECT()
            ...
            ->registerField('download_attr', FieldManager::TOGGLE()
                ->setLabel('Download Link')
                ->setDefault(false)
                ->setDescription('Force download instead of navigation')
            )
            ->registerField('download_filename', FieldManager::TEXT()
        ...
        $control->addGroup('accessibility', 'Accessibility')
            ...
            ->registerField('custom_attributes', FieldManager::TEXTAREA()
    ...
    public function getStyleFields(): array
    {
        ...
        $control->addGroup('colors', 'Colors')
            ...
            ->registerField('text_hover_color', FieldManager::COLOR()
        ...
        $control->addGroup('border', 'Border & Effects')
            ...
            ->registerField('border_hover_color', FieldManager::COLOR()
            ...
            ->registerField('box_shadow_hover', FieldManager::TEXT()
        ...
        $control->addGroup('alignment', 'Position & Alignment')
            ->registerField('link_alignment', FieldManager::SELECT()
