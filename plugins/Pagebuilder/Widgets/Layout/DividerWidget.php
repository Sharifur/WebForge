...
class DividerWidget extends BaseWidget
{
    ...
    public function getGeneralFields(): array
    {
        ...
        $control->addGroup('style_type', 'Divider Style')
            ->registerField('divider_type', FieldManager::SELECT()
            ...
            ->registerField('line_style', FieldManager::SELECT()
                ->setLabel('Line Style')
                ->setDefault('solid')
                ->setOptions([
                    'solid' => 'Solid',
        ...
        $control->addGroup('text_content', 'Text Content')
            ->registerField('divider_text', FieldManager::TEXT()
            ...
            ->registerField('text_position', FieldManager::SELECT()
        ...
        $control->addGroup('icon_content', 'Icon Content')
            ->registerField('divider_icon', FieldManager::ICON()
        ...
        $control->addGroup('dimensions', 'Dimensions')
            ->registerField('divider_width', FieldManager::NUMBER()
            ...
            ->registerField('divider_alignment', FieldManager::SELECT()
            ...
            ->registerField('thickness', FieldManager::NUMBER()
    ...
    public function getStyleFields(): array
    {
        ...
        $control->addGroup('line_colors', 'Line Colors')
            ->registerField('line_color', FieldManager::COLOR()
                ->setLabel('Line Color')
                ->setDefault('#CCCCCC')
        ...
        $control->addGroup('text_style', 'Text Style')
            ...
            ->registerField('text_background', FieldManager::COLOR()
            ...
            ->registerField('text_font_size', FieldManager::NUMBER()
            ...
            ->registerField('text_font_weight', FieldManager::SELECT()
            ...
            ->registerField('text_padding', FieldManager::DIMENSION()
